...
namespace TechTrove.DAL.Migrations
{
    ...
    [Migration("20240520182352_AddOrderProductCartCategoryItem")]
    partial class AddOrderProductCartCategoryItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TechTrove.DAL.Entities.TechTroveProduct", b =>
                {
                    ...
                    b.Property<int>("TechTroveOrderLineId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TechTroveOrderLineId");
            ...
            modelBuilder.Entity("TechTrove.DAL.Entities.TechTroveProduct", b =>
                {
                    ...
                    b.HasOne("TechTrove.DAL.Entities.TechTroveOrderLine", "TechTroveOrderLine")
                        .WithMany("TechTroveProducts")
                        .HasForeignKey("TechTroveOrderLineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
